...
function Projects(props) {
  ...
  const description = `I'm obsessed with side projects and <strong>building in public</strong>. Here are some Projects you can navigate to <strong>different</strong> websites and programs I built. Some projects are still active, others have been discontinued.`
