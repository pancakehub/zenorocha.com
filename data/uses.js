const categories = [
  {
    ...
    items: [
      {
        title: ' Bachelors credential',
        description:
          'Information Technology(16", 2024) from Vignan Institue of Technology and Science CGPA: 7.45',
        url: '#',
      },
      /*{
  ...
  },
  {
    ...
    items: [
      {
        title: 'Tech Stack',
        description: 'Java, Python, Web Development {Html, css}, JavaScript, Azure',
        url: '#',
      },
      {
        title: 'Familiar',
